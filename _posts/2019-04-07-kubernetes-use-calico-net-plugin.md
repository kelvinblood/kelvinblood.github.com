---
layout: post
title: kubernetes 使用 calico 网络协议
category: tech
...
关于k8s的安装可以参考我这篇文章：[《kubernetes 安装入门(centos)》](<https://blog.kelu.org/tech/2018/05/09/k8s-install-tutorial.html>),一路向下操作直到`8. 安装flannel网络` 前即可。
